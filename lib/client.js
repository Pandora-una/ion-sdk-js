...
class Client extends events_1.EventEmitter {
    ...
    publish(stream) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (_a = this.localStreams) === null || _a === void 0 ? void 0 : _a.push(stream);
    ...
    leave() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield Promise.all(this.localStreams.map((localStream) => __awaiter(this, void 0, void 0, function* () {
                    if (localStream.mid) {
                        yield localStream.unpublish();
                    }
                })));
                this.localStreams = [];
